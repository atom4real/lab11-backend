...
public interface EventRepository extends JpaRepository<Event,Long> {
    ...
    Page<Event> findByTitleContainingAndDescriptionContaining(String title, String title1, Pageable page);
    ...
    Page<Event> findByTitleIgnoreCaseContainingOrDescriptionIgnoreCaseContainingOrOrganizer_NameIgnoreCaseContaining(String title, String description, String organizerName, Pageable page);
}
